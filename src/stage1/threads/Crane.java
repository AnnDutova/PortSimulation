...
import stage1.time.Timer;

import java.util.concurrent.CyclicBarrier;

public class Crane extends Thread implements IObserver
{
    public static final int MAX_WEIGHT_LIQUID_CRANE = 9;
    public static final int MAX_WEIGHT_CONTAINER_CRANE = 15;
    public static final int MAX_WEIGHT_LOOSE_CRANE = 10;

    public static final int WAIT_FOR_CONTAINER = 5;
    public static final int WAIT_FOR_LOOSE = 2;
    public static final int WAIT_FOR_LIQUID = 3;
